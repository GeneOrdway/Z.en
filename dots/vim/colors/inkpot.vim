...
if has("gui_running")
    ...
    hi NonText        gui=BOLD   guifg=#8b8bcd   guibg=#1e1e27
    hi SpecialKey     gui=BOLD   guifg=#ab60ed   guibg=NONE
    hi Title          gui=BOLD   guifg=#af4f4b   guibg=NONE
    hi Visual         gui=NONE   guifg=#eeeeee   guibg=#4e4e8f

    hi Comment        gui=NONE   guifg=#767676   guibg=NONE
    ...
    hi doxygenComment               gui=NONE guifg=#767676   guibg=NONE
    ...
    exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(7) . " ctermbg=" . <SID>X(80)
    ...
    exec "hi Visual         cterm=NONE   ctermfg=" . "NONE " . " ctermbg=" . <SID>X(0)

    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(57) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(73) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=" . <SID>X(2) . " ctermbg=" . "NONE"
    exec "hi Error          cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(32)
    exec "hi Identifier     cterm=NONE   ctermfg=" . <SID>X(11) . " ctermbg=" . "NONE"
    exec "hi Ignore         cterm=NONE"
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(9) . " ctermbg=" . "NONE"
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(6) . " ctermbg=" . "NONE"
    exec "hi Special        cterm=NONE   ctermfg=" . <SID>X(14) . " ctermbg=" . "NONE"
    ...
    exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(3) . " ctermbg=" . "NONE"
    ...
    if v:version >= 700
        ...
        exec "hi MatchParen     cterm=NONE ctermbg=" . <SID>X(1) . "ctermfg=" . <SID>X(25)
    endif
endif
