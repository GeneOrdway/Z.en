...
ARRAY_LARGEST_FILE_SIZES[WALKER]=sprintf("%.2f", ARRAY_FILE_SIZES[WALKER,CURRENT_STEP], ARRAY_FILE_SIZE_LABELS[CURRENT_STEP])
...
#printf "ARRAY_LARGEST_FILE_SIZES[1] is: " "%.2f\n", ARRAY_LARGEST_FILE_SIZES[1] 
#for (k = 1; k <= length(ARRAY_LARGEST_FILE_SIZES); k++) { 
#    print ""
#    print ARRAY_LARGEST_FILE_SIZES[k]
#    }
