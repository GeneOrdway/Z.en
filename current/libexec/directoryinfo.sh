...
PERMISSIONS="${ARRAY_DIRECTORY_INFO[0]}"
PERMISSIONS_NUMBER="${ARRAY_DIRECTORY_INFO[1]}"
...
# Debugging information:
    ...
    $PRINTF "PERMISSIONS_NUMBER is: $PERMISSIONS_NUMBER\n"
    $PRINTF "USER_NAME is: $USER_NAME\n"
    $PRINTF "USER_ID is: $USER_ID\n"
    $PRINTF "GROUP_NAME is: $GROUP_NAME\n"
    $PRINTF "GROUP_ID is: $GROUP_ID\n"
    $PRINTF "TIME_ACCESS is: $TIME_ACCESS\n"
    $PRINTF "TIME_MODIFIED is: $TIME_MODIFIED\n"
    $PRINTF "TIME_CHANGE is: $TIME_CHANGE\n"
    $PRINTF "TIME_BIRTH is: $TIME_BIRTH\n"
    $PRINTF "CURRENT_YEAR is: $CURRENT_YEAR\n"
    $PRINTF "Stat year is: ${ARRAY_DIRECTORY_INFO[7]}\n"
#fi

# Standardize the output:
PERMISSIONS_OUTPUT="$ICON_PERMISSIONS $PERMISSIONS($PERMISSIONS_NUMBER)"
...
#
if [[ ${ARRAY_DIRECTORY_INFO[7]} = $CURRENT_YEAR ]]; then
    $PRINTF "Year comparison: true\n"
else
    $PRINTF "Year comparison: false\n"
fi
