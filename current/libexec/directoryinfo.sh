...
TIME_CHANGE=""
FILE_SIZE="$ICON_DIRECTORY $NUMBER_OF_DIRECTORIES $ICON_FILE $NUMBER_OF_FILES, $FILE_SIZES_TOTAL_HUMAN"
...
# Final output:
$PRINTF "$PERMISSIONS$USER_NAME$GROUP_NAME$FILE_SIZE$TIME_MODIFIED\n"
